...
sudo cp $1/mount/userdata/data/com.whatsapp/files/key $1/extracted\ data/whatsapp/encryption-key		
sudo cp $1/mount/userdata/media/0/WhatsApp/Databases/msgstore.db.crypt8 $1/extracted\ data/whatsapp/
...
cp -rf $1/mount/userdata/media/0/WhatsApp/Media/ $1/extracted\ data/whatsapp/
cp -rf $1/mount/userdata/media/0/WhatsApp/Profile\ Pictures/ $1/extracted\ data/whatsapp/
